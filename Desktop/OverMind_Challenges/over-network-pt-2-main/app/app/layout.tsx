  ...
  */
    ...
    */
          try {
            ...
            await dropUser(newUser); // Remove the user from the local account cache
            throw error; // Rethrow the error to be caught by the catch block in the loginWindow.tsx file
         }
  }
